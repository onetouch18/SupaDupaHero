...
public class MainMenu : Photon.MonoBehaviour
{
    ...
    private string gameVersion = "v1.1";
	...
	*/
    ...
    {	
		...
		//#endif
			//gameVersion = Random.Range (int.MinValue, int.MaxValue).ToString ();
	...
	IEnumerator loading(){
		load = Application.LoadLevelAsync ("TestLvl");
	...
	public void Connect(){
		...
		info.text = "Log: Try to connect";
		PhotonNetwork.playerName = PlayerPrefs.GetString("playerName", "Guest" + Random.Range(1, 9999));
	}

	void OnConnectedToMaster(){
		info.text = "Log: Connected";
    ...
    void OnJoinedRoom()
    {
		...
		//SceneManager.LoadSceneAsync ("TestLvl");
    ...
    void RoomBrowser(int id)
    {
        ...
        if (GUILayout.Button("GO", GUILayout.Height(80), GUILayout.Width(160)))
		{	if(PhotonNetwork.countOfRooms == 0)
